...
def compute_accuracy(model, dataloader, get_confusion_matrix=False, device: Union[str, torch.device] = "cpu"):
        ...
        for tmp in dataloader:
            for batch_idx, (x, target) in enumerate(tmp):
                ...
                if get_confusion_matrix:
                    ...
                    pred_labels_list = np.append(pred_labels_list, pred_label.data.cpu().numpy())
